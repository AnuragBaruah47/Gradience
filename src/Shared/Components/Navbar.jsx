    ...
    <nav className="w-full dark:text-white py-8 flex items-center justify-center">
      <div className="flex w-xl">
        ...
        <div className="flex cursor-pointer items-center">
          <h1 className="text-[20px] font-medium">Gradi</h1>
          <h1 className="text-[20px] font-semibold text-[#818181]">ence</h1>
        </div>
      </div>
      <div className="flex gap-2 items-center">
        <div
          ...
          className="rounded-4xl transition-all duration-300 cursor-pointer p-1.5 
hover:bg-white/10 
...
hover:shadow-lg"
        ...
        <div
          ...
          className="hhh rounded-4xl transition-all duration-300 cursor-pointer p-1.5 
hover:bg-white/10 
hover:backdrop-blur-md 
 hover:border-white/20 
hover:shadow-lg"
        ...
        <div
          ...
          className="hhh rounded-4xl transition-all duration-300 cursor-pointer p-1.5 
hover:bg-white/10 
hover:backdrop-blur-md  hover:border-white/20 
hover:shadow-lg"
        >
          <svg
            ref={innerRef}
            className="w-9 h-9 dark:text-white text-black"
            viewBox="0 0 48 48"
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            stroke="currentColor"
